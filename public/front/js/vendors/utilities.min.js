            ...
            r = {
                addActive: function (n) {
                    "/" == location.pathname[ location.pathname.length - 1 ] ? n[ 0 ].classList.add(t.activeClass) : n.forEach(n => {
                        n.children[ 0 ].attributes[ 0 ].value.includes("https://www.indonez.com/html-demo/") && n.children[ 0 ].attributes[ 0 ].value.slice(3) == e && n.classList.add(t.activeClass), n.children[ 0 ].attributes[ 0 ].value == e && n.classList.add(t.activeClass)
                    })
                },
...
if (activeMenu(), breadcrumb(), mobileNav(), function () {
    ...
    t.setAttribute("src", "https://www.indonez.com/html-demo/js/blog/category-data.js"), n.setAttribute("src", "https://www.indonez.com/html-demo/js/blog/tag-data.js"), e.appendChild(t), e.appendChild(n)
}
    ...
    if ("complete" == document.readyState && document.querySelector(".in-blog-1") && !document.querySelector(".in-article")) {
        ...
        if (a.forEach(e => {
            ...
            e.innerHTML = function (t, a) {
                ...
                for (let e = o; e <= l; e++) e > t || (0 == e && (e += 1), i = a == e ? 'class="uk-active"' : "", r += `<li ${ i }><a href="https://www.indonez.com/error/404.html">${ e }</a></li>`);
